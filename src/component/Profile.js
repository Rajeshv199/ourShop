            ...
            <div className="profile-card">
                <div className='row mx-0'>
                    <div className='col-4 leftSide '>
                        ...
                        <div>
                            <Link to="/signup" className='text-white' state={{user}} ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="20px" >
                    ...
                    <div className='col-8 px-4 py-2 rightSide'>
                        ...
                        <div className='text-primary py-3 cursor-pointer'><Link to="/updatePassword" className='text-primary'>Change Password</Link></div>
